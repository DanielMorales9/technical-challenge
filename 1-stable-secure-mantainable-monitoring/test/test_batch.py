...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        main(sys.argv[1])
    elif 'testcases/unit-tests.in.txt' in os.listdir('.'):
        main('testcases/unit-tests.in.txt')
    else:
        print("Where is my input? input.txt does not exist, "
              "Create one, or provide a filename as an argument")